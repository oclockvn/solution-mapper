...
{
    [Fact]
    public void Closure_follows_transitive_references()
    {
        ...
        var graph = ProjectGraph.Build(ProjectDiscovery.FindProjects(tree.Root));
    ...
    [Fact]
    public void Closure_is_cycle_safe()
    {
        using var tree = TempSolutionTree.Create();
    ...
    [Fact]
    public void Closure_deduplicates_diamond_dependencies()
    {
        using var tree = TempSolutionTree.Create();
    ...
    [Fact]
    public void Build_resolves_by_filename_when_relative_path_missing()
    {
        using var tree = TempSolutionTree.Create();
    ...
    [Fact]
    public void Build_leaves_edge_unresolved_when_reference_is_external()
    {
        using var tree = TempSolutionTree.Create();
        tree.AddProject("Web/Web.csproj",
